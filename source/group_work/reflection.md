...
A continuació hi ha preguntes de reflexió sobre el treball en equip. Recomanem que les integreu en algun dels qüestionaris en línia (per exemple, Google Forms, Microsoft Forms o l'eina que utilitzeu a la vostra plataforma), les compartiu amb els estudiants i després que els estudiants completin el qüestionari, discutiu conjuntament les preguntes i els resultats.
...
#### Proposta per a la discussió després del qüestionari

Reviseu els resultats amb els estudiants. Si la puntuació mitjana per a algun principi és inferior a 3, és un signe que l'equip hauria de treballar en millorar aquest aspecte del treball en equip en el futur. Animeu els estudiants a ser concrets: què exactament va passar, per què, i què cada membre de l'equip podria fer diferent la pròxima vegada.
```
